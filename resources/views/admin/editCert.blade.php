              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/edit_Cert')}}/{{$Cert->id}}" enctype="multipart/form-data">
                   
                
                    <div class="form-group">
                    <label class="control-label col-lg-4">Cert Category</label>
                    ...
                    <div class="col-lg-8">
                        <select name="cat" data-placeholder="Choose Category" class="form-control chzn-select" tabindex="2">
                           <option selected="selected" value="{{$Cert->cat}}"> <?php $TheCat = DB::table('category')->where('id',$Cert->cat)->get(); ?> @foreach($TheCat as $cat) {{$cat->cat}} @endforeach</option>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{url('/')}}/uploads/certificates/{{$Cert->cert}}" alt="" /></div>
                    ...
                    <input type="hidden" name="image_cheat" value="{{$Cert->cert}}">
