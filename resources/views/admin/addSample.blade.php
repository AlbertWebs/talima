              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/add_Sample')}}" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="price" value="" placeholder="e.g KES 20000 or USD 20" class="form-control" />
                        </div>
                    </div>
