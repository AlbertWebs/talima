              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/add_Teacher')}}" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-12 text-center">
                      <button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> Add Instuctor</button>
                    </div>
