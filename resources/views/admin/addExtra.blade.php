				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select name="type" data-placeholder="Choose Destination" class="form-control chzn-select" tabindex="2">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-4">Add Parent Destination</label>
                        ...
                        <div class="col-lg-8">
                            <select name="product_id" data-placeholder="Choose Destination" class="form-control chzn-select" tabindex="2">
                               ...
                               <?php $TheCategoryListEx = DB::table('experiences')->get(); ?>
                               @foreach($TheCategoryList as $value)
                                  <option value="{{$value->id}}">{{$value->title}}</option>
                               @endforeach
                               @foreach($TheCategoryListEx as $value)
                               <option value="{{$value->id}}">{{$value->title}}</option>
                               @endforeach
