               ...
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/savesitesettings')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="pass1" class="control-label col-lg-4">MPESA</label>

                        <div class="col-lg-8">
                            <input class="form-control" value="{{$value->mpesa}}" name="mpesa" type="text" placeholder="e.g +254723014032" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="{{$value->paypal}}" name="paypal" type="text" placeholder="e.g email@domain.com" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="{{$value->instagram}}" name="instagram" type="url" placeholder="e.g https://www.linkedin.com/designekt" >
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                        ...
                                        <textarea name="welcome" id="wysihtml55" class="form-control" rows="10">{{$value->welcome}}</textarea>
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                        ...
                                        <textarea name="director" id="wysihtml5" class="form-control" rows="10">{{$value->director}}</textarea>
                    ...
                    <div class="form-group col-lg-12">
                        <label class="control-label">SiteLogo-2</label>
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{url('/')}}/uploads/logo/{{$value->logoo}}" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                                    <span class="btn btn-file btn-primary"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span><input name="logoo" type="file" /></span>
                                    <a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload">Remove</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <input type="hidden" name="logoo_cheat" value="{{$value->logoo}}">
