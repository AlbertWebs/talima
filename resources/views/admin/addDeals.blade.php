              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/add_Deals')}}" enctype="multipart/form-data">

                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Deals Title</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="title" value="" placeholder="e.g Deals" class="form-control" />
                        </div>
                    </div>
