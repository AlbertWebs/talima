               ...
               <center>
				...
				@endif
                 ...
                 <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="name" value="" placeholder="e.g English" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                    <label class="control-label col-lg-4">Course Instructor</label>

                    
                        

                    <div class="col-lg-8">
                        <select name="teacher" data-placeholder="Choose Instructor" class="form-control chzn-select" tabindex="2">
                          
                           <?php $TheCategoryList = DB::table('teachers')->get(); ?>
