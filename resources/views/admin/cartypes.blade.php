                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            @foreach($CarType as $value)
                                                <tr class="odd gradeX">
                                                    <td>{{$value->id}}</td>
                                                    <td>{{$value->name}}</td>
                                                    <td class="center"><img width="200"  src="{{url('/')}}/uploads/cartypes/{{$value->image}}"></td>
                                                    <td class="center"><a href="{{url('/admin')}}/editCarType/{{$value->id}}"   class="btn btn-info"><i class="icon-pencil icon-white"></i> Edit</a></td>
